...
static const uint8_t rsakey[]  ICACHE_RODATA_ATTR = {
  
};

static const uint8_t x509[] ICACHE_RODATA_ATTR = {
  0x30, 0x82, 0x01, 0x43, 0x30, 0x81, 0xee, 0x02, 0x09, 0x00, 0x80, 0xa2,
  0xd1, 0x19, 0xd6, 0xf1, 0xf4, 0xc5, 0x30, 0x0d, 0x06, 0x09, 0x2a, 0x86,
  ...
  0x2e, 0x30, 0x2e, 0x31, 0x30, 0x1e, 0x17, 0x0d, 0x31, 0x37, 0x30, 0x33,
  0x30, 0x34, 0x32, 0x31, 0x30, 0x35, 0x31, 0x37, 0x5a, 0x17, 0x0d, 0x33,
  0x30, 0x31, 0x31, 0x31, 0x31, 0x32, 0x31, 0x30, 0x35, 0x31, 0x37, 0x5a,
  ...
  
};
